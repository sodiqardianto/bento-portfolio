...
export default function Intro() {
  return (
    <>
      ...
      >
        <h6 className="text-sm font-light text-gray-500">welcome</h6>
        <div className="flex flex-col justify-between h-full">
          <div className="flex-row text-xl font-light m-0">
          ...
          <div className="flex gap-2">
            <button className="px-2 py-2 rounded-md bg-teal-500 text-white font-bold transition duration-200 hover:bg-white hover:text-black border-2 border-transparent hover:border-teal-500">
